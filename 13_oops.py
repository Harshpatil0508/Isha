...
# Tommorrow To-do
# 1. pip install and package management and virtual enviroment ,git   
# 2. ML basics,Regression Techniques

# Create virtual Enviroment command :  python -m venv name
